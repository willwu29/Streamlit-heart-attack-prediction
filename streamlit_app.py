...
if st.session_state.page == 'welcome':
    ...
    '>
        ...
        <ul style='font-size: 14px; padding-left: 20px;'>
            <li>Leading cause of death in the US with over 800k incidents annually—about one heart attack every 40 seconds.</li>
            <li>Heart attack healthcare costs exceed $160 billion USD each year.</li>
            ...
            <li>Current assessment tools (🧮 Additional Calculators) require blood test inputs, limiting accessibility.</li>
        </ul>
    </div>
    """, unsafe_allow_html=True)
