...
if st.session_state.page == 'welcome':
    ...
    with st.container():
        ...
        step_content = [
            ("1. Assess", "📝 Risk Assessment", "Evaluate heart attack risk using my ML model"),
            ("2. Validate", "🧮 Calculators", "Cross-check with external clinical tools"),
            ("3. Explore", "📊 Data Analysis", "Learn more about heart attack statistics"),
            ("4. Learn ML", "🤖 ML Insights", "Discover my machine learning model")
        ]
